# Final Iteration of Bowling game problem
# First Change: Fixed bad spacing problems on application by changing all font to courier font.
# Second Change: Changed reset: now empties all data when a game is reset.
# Third Change: Entry box now empties when enter score is clicked on.
